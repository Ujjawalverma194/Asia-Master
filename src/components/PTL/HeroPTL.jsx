    ...
    <section ref={ref} style={styles.section}>
      ...
      <div style={styles.wrapper}>
        <div style={styles.content}>
          <div style={styles.eyebrow}>Part Truck Load Logistics</div>

          <h1 style={styles.title}>
            Parchoon / <span style={styles.titleAccent}>PTL</span>
          </h1>

          <p style={styles.para}>
            Asia Master offers dependable parcel and part-load transportation
            for businesses that need flexible, safe, and cost-effective movement
            without booking an entire truck.
          </p>

          <p style={styles.para}>
            Our PTL service is ideal for MSMEs, traders, manufacturers, and
            growing brands that require door-to-door delivery, route visibility,
            warehouse coordination, and reliable handling across major business
            regions.
          </p>
          ...
          <div style={styles.points}>
            {[
              ...
              <div key={item[0]} className="ptl-point" style={styles.point}>
          ...
          <div style={styles.actions}>
            <button className="ptl-primary" style={styles.primaryBtn}>
              Get PTL Quote
              <span style={styles.circle}>→</span>
            </button>

            <button className="ptl-secondary" style={styles.secondaryBtn}>
              Track Shipment
            </button>
          </div>
        </div>
        ...
        <div style={styles.imageArea}>
          ...
          <div style={styles.badge}>
            <div style={styles.badgeTop}>PTL</div>
            <div style={styles.badgeText}>Flexible cargo movement</div>
          </div>
        </div>
      </div>
    </section>
